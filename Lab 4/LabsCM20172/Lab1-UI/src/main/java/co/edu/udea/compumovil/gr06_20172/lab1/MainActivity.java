...
public class MainActivity extends AppCompatActivity {
    ...
    ListApartmentFragment listapart = new ListApartmentFragment();
    ///////////////
    Fragment apart = new ApartmentFragment();
    Fragment apart1 = new ListApartmentFragment();
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()){
                            ...
                            case R.id.info:
                                System.out.println("extra pass "+ getIntent().getExtras().getString(EXTRA_PASS));
                                if ((getIntent().getExtras().getString(EXTRA_PASS)).equals("google")){
                                    ProfileGoogleFragment fragmentP = new ProfileGoogleFragment();
                                    FragmentTransaction fragmentTransactionP = getSupportFragmentManager().beginTransaction();
                                    fragmentTransactionP.replace(R.id.fragment_container,fragmentP);
                                    ...
                                    args.putString("myString", getIntent().getExtras().getString(EXTRA_NAME));
