...
public class PresupuestoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtValidate[0]=(EditText)findViewById(R.id.valorPresupuesto);
        txtValidate[1]=(EditText)findViewById(R.id.txtDescripPresupuesto);
        txtValidate[2]=(EditText)findViewById(R.id.txtDateInicioPresupuesto);
        txtValidate[3]=(EditText)findViewById(R.id.txtDateFinPresupuesto);

        dbH = new DbHelper(this);
        btnRegistrarPresupuesto = (Button)findViewById(R.id.btnEnviarPresupuesto);
        spinnerCategoryDebit = (MaterialBetterSpinner) findViewById(R.id.category_pre_spinner);
        ...
        TextWatcher btnActivation = new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if(verificarVaciosSinMessage(txtValidate)){btnRegistrarPresupuesto.setEnabled(true);}
                else{btnRegistrarPresupuesto.setEnabled(false);}
            }
        };
    ...
    public void savePresupuesto(View v) throws IOException {
        ...
        if (!verificarVacios(txtValidate)){
            ...
            String dateIni = txtValidate[2].getText().toString();
            String dateFin = txtValidate[3].getText().toString();
            ...
            budget = new Budget(amount, description, dateIni, dateFin);
            dbH.addBudget(budget, userId.toString(), categoryId.toString());

            //newUser = dbH.addUser(user);
            control=true;
            Intent ppalActivity = new Intent(PresupuestoActivity.this, PrincipalActivity.class);
